...
# First Try to the code

# class Vehicle:
#     def __init__(self, vehicle_id, vehicle_type, vehicle_cost, premium_amount = 0):
...
#     def calculate_premium(self, vehicle_id, vehicle_cost, vehicle_type):
#         if vehicle_type == "Two Wheeler":
#             amount = 2/100 * vehicle_cost
#             self.set_premium_amount(amount)
#         elif vehicle_type == "Four Wheeler":
#             amount = 6/100 * vehicle_cost
#             self.set_premium_amount(amount)
#         else:
#             print("Error: Please enter a valid vehicle type.")
#         return self.get_premium_amount

#     def display_details(self):
#         return (self.get_vehicle_id, self.get_vehicle_type, self.get_vehicle_cost)

# Vehicle1 = Vehicle(2421,"Two Wheeler", 105000)
# print(Vehicle1.calculate_premium(2421, 105000, "Two Wheeler"))
